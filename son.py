...
def main():
    ...
    for j in range(df.size):
        ...
        df.iloc[j]['WB Is All Capital'] = isCapital(df.index[j - 1]).isupper()
        ...
        df.iloc[j]['W Is All Capital'] =  isCapital(df.index[j]).isupper()
        ...
        df.iloc[j]['WA Is All Capital'] = isCapital(df.index[j + 1]).isupper()
